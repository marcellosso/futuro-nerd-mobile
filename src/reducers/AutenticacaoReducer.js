...
const INITIAL_STATE = {
  emailPai:'anderson@goowords.com.br',
  senhaPai:'123456',
  nomePai:'',
  celularPai:'',
  cpfPai:'',
  ...
  emailFilho: 'anderson@goowords.com.br',
  senhaFilho: '123456',
...
export default (state = INITIAL_STATE, action) => {
  ...
  switch(action.type) {
    ...
    case CADASTRO_PAI_SUCESSO:
      return { ...state, loading_cadastro: false, senhaPai: null, nomePai: null, celularPai: null, cpfPai: null, }
